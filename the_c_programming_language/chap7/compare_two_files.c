...
/* The check if (lp1 == line1 && lp2 == line2) ensures that both fgets
 * calls were successful by verifying that the pointers lp1 and lp2 point
 * to the beginning of their respective buffers.
 */
